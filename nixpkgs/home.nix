...
in
{
      ...
      (
        import (
          builtins.fetchTarball {
            url = https://github.com/nix-community/neovim-nightly-overlay/archive/0f13d55e4634ca7fcf956df0c76d1c1ffefb62a3.tar.gz;
          }
        )
      )
    ];
  ...
  home = {
    ...
    file = {
      ...
      ".config/xplr/plugins/init.lua".source = ./files/xplr/plugins/init.lua;
      ".config/xplr/plugins/icons/init.lua".source = ./files/xplr/plugins/icons/init.lua;
      ".config/xplr/plugins/theme/init.lua".source = ./files/xplr/plugins/theme/init.lua;
      ".config/xplr/plugins/du/init.lua".source = ./files/xplr/plugins/du/init.lua;
      ".config/xplr/plugins/fzf/init.lua".source = ./files/xplr/plugins/fzf/init.lua;
      ".config/xplr/plugins/nnn_preview_wrapper/init.lua".source = ./files/xplr/plugins/nnn_preview_wrapper/init.lua;
      ".config/xplr/plugins/scroll/init.lua".source = ./files/xplr/plugins/scroll/init.lua;
      ".config/xplr/plugins/visit_path/init.lua".source = ./files/xplr/plugins/visit_path/init.lua;
      ".config/xplr/plugins/trash_cli/init.lua".source = ./files/xplr/plugins/trash_cli/init.lua;
      ".config/xplr/plugins/dua-cli/init.lua".source = ./files/xplr/plugins/dua-cli/init.lua;
      ".config/xplr/plugins/double_colon/init.lua".source = ./files/xplr/plugins/double_colon/init.lua;
